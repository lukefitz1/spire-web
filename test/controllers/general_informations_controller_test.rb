...
class GeneralInformationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create general_information" do
    assert_difference('GeneralInformation.count') do
      post general_informations_url, params: { general_information: { information: @general_information.information, information_label: @general_information.information_label } }
    end
  ...
  test "should update general_information" do
    patch general_information_url(@general_information), params: { general_information: { information: @general_information.information, information_label: @general_information.information_label } }
