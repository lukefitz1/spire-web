...
class CollectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collection" do
    assert_difference('Collection.count') do
      post collections_url, params: { collection: { collectionName: @collection.collectionName, customer_id: @collection.customer_id } }
    end
  ...
  test "should update collection" do
    patch collection_url(@collection), params: { collection: { collectionName: @collection.collectionName, customer_id: @collection.customer_id } }
